...
const ENDPOINTS: Endpoint[] = [
  ...
  { method: "GET", path: "/api/globalsearch?q=...", auth: "public", description: "Global search across papers, quizzes, notes, people and the John Web library." },
  ...
  },
  {
    ...
    auth: "user",
    body: "{ uid, toEmail?, toUid?, coins, memo? }",
    description: "Send NexaCoin to another wallet (QR / @username payments, or by uid).",
  },
  {
    method: "POST",
    path: "/api/nexas/exchange",
    auth: "user",
    body: "{ uid, direction: \"in\"|\"out\", amount }",
    description: "Bridge CooperCoins ↔ NexaCoin at the fixed CC rate.",
  },
  {
    method: "POST",
